#!/bin/sh
#
# SYSCONF-version of syntax-hightlighting.sh to use highlight v3
# /etc/cgitrc is modified to use this version
#
...
echo coucou
exec highlight --force --inline-css -f -I -O xhtml -S "$EXTENSION" 2>&1 #2>/dev/null
